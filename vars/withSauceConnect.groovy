...
def call(String sauceid, Closure body) {
    sauce(sauceid) {
              sauceconnect(options: '--proxy reformmgmtproxyout.reform.hmcts.net:8080 --verbose --no-remove-colliding-tunnels --tunnel-identifier reformtunnel', useGeneratedTunnelIdentifier: false,
