...
def call() {
  ...
  try {
    ...
    WarningCollector.addPipelineWarning("deprecated_postgres", "${repositoryShortUrl} Please migrate to the flexible server postgres module. See this Slack announcement for more info https://hmcts-reform.slack.com/archives/CA4F2MAFR/p1692714862133249", date)
  } finally {
