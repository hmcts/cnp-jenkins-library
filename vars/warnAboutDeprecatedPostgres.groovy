...
def call() {
  ...
  try {
    ...
    WarningCollector.addPipelineWarning("deprecated_postgres", "Please migrate to the flexible server postgres module https://github.com/hmcts/terraform-module-postgresql-flexiblek con", LocalDate.of(2023, 8, 9))
  } finally {
