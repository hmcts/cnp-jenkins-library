def call(String s2sServiceName, String environment, String product, String tenantId,String folder) {
  ...
  stageWithAgent('Camunda - Publish BPMN and DMN', product) {
    ...
    ./publish-camunda-processes.sh $WORKSPACE $s2sUrl $s2sServiceName $camundaUrl $product $tenantId $folder
    """
