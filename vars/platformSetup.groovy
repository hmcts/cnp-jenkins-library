def call(body) {
  ...
  ansiColor('xterm') {
    ...
    withCredentials([string(credentialsId: 'sp_password', variable: 'ARM_CLIENT_SECRET'),
                     ...
                     string(credentialsId: 'kitchen_client_secret', variable: 'TF_VAR_secret_access_key'),
        			       string(credentialsId: 'kitchen_tenant_id', variable: 'TF_VAR_tenant_id'),
        			     	 string(credentialsId: 'kitchen_subscription_id', variable: 'TF_VAR_subscription_id'),
        			     	 string(credentialsId: 'kitchen_client_id', variable: 'TF_VAR_client_id'),
