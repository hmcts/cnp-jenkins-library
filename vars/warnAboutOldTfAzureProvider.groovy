...
def call() {
  ...
  try {
    ...
    WarningCollector.addPipelineWarning("updated_azurerm_provider", "Please upgrade azurerm to the lastest 2.x version. For an example, see: https://github.com/hmcts/rpe-pdf-service/pull/281", new Date().parse("dd.MM.yyyy", "06.10.2020"))
  } finally {
