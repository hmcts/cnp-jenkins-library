...
--- | --- | ---
 ...
 SecurityScan | Security scan functionality has been split for frontend and backend specific scans:<br><br> <ul><li>enableSecurityScanFrontend() <li>enableSecurityScanBackend() </ul> <br> If enableSecurityScan() used previously, use one of the two above options and remove security.sh file from root of repository | [Web Application example](https://github.com/hmcts/probate-frontend/blob/a56b63fb306b6b2139148c27b7b1daf001f2743c/security.sh) <br>[API example](https://github.com/hmcts/document-management-store-app/blob/master/security.sh)
