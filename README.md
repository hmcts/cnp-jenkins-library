...
--- | --- | ---
 ...
 SecurityScan | Security scan functionality has been split for frontend and backend specific scans:<br><br> <ul><li>enableSecurityScanFrontend() <li>enableSecurityScanBackend() </ul> <br> If enableSecurityScan() was used previously, use one of the two above options and remove security.sh file from root of repository | [Web Application example](https://github.com/hmcts/sds-toffee-frontend/pull/116/files) <br>[API example](https://github.com/hmcts/sds-toffee-recipes-service/pull/131/files)
