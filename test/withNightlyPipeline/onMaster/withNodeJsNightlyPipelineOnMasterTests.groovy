...
class withNodeJsNightlyPipelineOnMasterTests extends BaseCnpPipelineTest {
  ...
  @Test
  void NightlyPipelineUsesXuiNodeLabelWithoutDailyLabel() {
    def nodeLabels = []
    ...
    runScript("testResources/exampleXuiNodeJsNightlyPipeline.jenkins")

    assertThat(nodeLabels).containsExactly('xui')
  }
}
