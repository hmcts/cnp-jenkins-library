...
abstract class BaseCnpPipelineTest extends BasePipelineTest {
  ...
  BaseCnpPipelineTest(String branchName, String jenkinsFile) {
    ...
    binding.setVariable("env", [
      ...
      ARM_SUBSCRIPTION_ID: 'target-subscription-id', JENKINS_SUBSCRIPTION_ID: 'jenkins-subscription-id', JENKINS_SUBSCRIPTION_NAME: 'DTS-CFTPTL-INTSVC', STORE_rg_name_template: '', STORE_sa_name_template: '', STORE_sa_container_name_template: '',
    ...
    helper.registerAllowedMethod('fileExists', [String.class], { c -> c == 'localPath/infrastructure' || c == 'Dockerfile' || c.startsWith('charts') || c == '.nvmrc' })
    helper.registerAllowedMethod('readFile', [String.class], { c -> '20.14.0' })
