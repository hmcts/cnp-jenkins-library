...
class EnvironmentDnsConfigTest extends Specification {
  ...
  def "getEntry() should return a correctly configured entry for a known crime-idam environment"() {
  ...
  def "getEntry() should return null for an unknown crime-idam environment"() {
