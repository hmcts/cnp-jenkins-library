...
class SecurityScan implements Serializable {
    public static final String OWASP_ZAP_IMAGE = 'ghcr.io/zaproxy/zaproxy:20250707-stable@sha256:1832ccb6b361763250a8be11c75ee5f49e76f16c0940459adb7619929110fd8e'
    public static final String OWASP_ZAP_ARGS = '-u 0:0 --name zap -p 1001:1001 -v $WORKSPACE:/zap/wrk/:rw'
    public static final String GLUEIMAGE = 'hmctspublic.azurecr.io/zap-glue:fcfcf9cd-1765883660'
