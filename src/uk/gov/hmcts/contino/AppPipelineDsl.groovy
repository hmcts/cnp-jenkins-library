...
class AppPipelineDsl extends CommonPipelineDsl implements Serializable {
  ...
  void installCharts() {
    WarningCollector.addPipelineWarning("install_charts", "installCharts() is deprecated and no longer does anything, please remove this flag before the pipeline starts failing.,", new Date().parse("dd.MM.yyyy", "21.05.2020"))
  }
