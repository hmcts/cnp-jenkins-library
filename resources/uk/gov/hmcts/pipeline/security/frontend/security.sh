...
/opt/zap/zap.sh -daemon -host 0.0.0.0 -port 10001 -config database.newsession=3 -config database.newsessionprompt=false -config api.disablekey=true \
...
curl --fail http://0.0.0.0:10001/OTHER/core/other/jsonreport/?formMethod=GET --output report.json
