...
if [[ "$azurerm_major" != "1" && "$azurerm_major" != "0" ]] && [[ "$terraform_minor" != "11" ]] ; then
  ...
  echo "=====  The contents of this file will just be a version number                                 ======"
  echo "=====  0.13.2                                                                                  ======"
  echo "=====                                                                                          ======"
  ...
  echo "=====                                                                                          ======"
  echo "=====  Add a required_providers block which specifies minimum version of azurerm               ======"
  echo "=====  terraform {                                                                             ======"
